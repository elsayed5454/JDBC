...
public class MyResultSet implements ResultSet {
	...
	// Returns the Integer value of a specific column in the current row GIVEN THE COLUMN INDEX STARTING FROM 1
	@Override
	...
	// Returns the Integer value of a specific column in the current row GIVEN THE COLUMN LABEL
	@Override
	...
	// Returns the String value of a specific column in the current row GIVEN THE COLUMN INDEX STARTING FROM 1
	public String getString(int columnIndex) throws SQLException {

		return (Result.get(currentInd).get(columnIndex)).toString();
	}

	// Return the String value of a specific column in the current row GIVEN THE COLUMN LABEL
	@Override
	...
	// ALL FOLLOWING METHODS ARE UNSUPPORTED AND HAVE EMPTY IMPLEMENTATION
